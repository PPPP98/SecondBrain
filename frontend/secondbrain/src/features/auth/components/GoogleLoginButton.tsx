...
export function GoogleLoginButton({ text = 'signin' }: GoogleLoginButtonProps) {
  ...
  return (
    <button
      ...
      className="flex min-w-[200px] cursor-pointer items-center justify-center rounded border border-[#747775] bg-transparent px-3 py-2.5 text-sm font-medium leading-5 text-white transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 active:bg-gray-100"
    >
