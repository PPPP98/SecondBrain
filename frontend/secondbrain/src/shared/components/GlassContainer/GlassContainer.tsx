...
export function GlassContainer({ children, className = '' }: GlassContainerProps) {
  return (
    <div
      className={`backdrop-saturate-180 relative flex h-full flex-col rounded-3xl bg-white/15 p-6 font-medium text-white shadow-[0px_12px_40px_rgba(0,0,0,0.25)] backdrop-blur-[3.5px] ${className}`}
    >
