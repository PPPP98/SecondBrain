class Prompts:
    ...
    **관련 없음 (is_relevant: false)**:
    ...
    GENERATE_RESPONSE_PROMPT = """당신은 검색 결과를 정리하는 어시스턴트입니다.
    ...
    ## 예시
    질문 : React Hook 사용법
    찾은 노트 제목 : React Hooks 기본, seState 활용, 커스텀 Hook
    **답변** : React Hook 사용법으로 React Hooks, seState 활용, 커스텀 Hook 과 관련된 노트를 찾았습니다!
